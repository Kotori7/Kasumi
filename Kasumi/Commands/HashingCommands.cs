...
namespace Kasumi.Commands
{
    public class HashingCommands
    {
        ...
        //private RIPEMD160 ripehash = RIPEMD160.Create();
        ...
        //[Command("ripemd")]
        //[Description("Hashes a provided string with RIPEMD160.")]
        //public async Task RIPEMDHash(CommandContext ctx, params string[] args)
        //{
        //    string input = String.Join(" ", args);
        //    byte[] d = ripehash.ComputeHash(Encoding.UTF8.GetBytes(input));
        //    StringBuilder s = new StringBuilder();
        //    for (int i = 0; i < d.Length; i++)
        //    {
        //        s.Append(d[i].ToString("x2"));
